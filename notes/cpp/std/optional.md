...
`std::optional` (_опциональный тип_) — вспомогательный класс для хранения
значения, которое может быть инициализированно или нет. Концептуально это
nullable тип, аналоги которого есть в более высокоуровненых языках.
...
Не рекомендуется использовать опциональный тип для хранения `bool` и `Type*`.
