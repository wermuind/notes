...
<dfn>Контекстно-свободная грамматика</dfn> (context-free grammar, CFG) –
...
<dfn>Терминальный символ</dfn> (terminal symbol) – символ, непосредственно
присутствующий в языке и имеющий символьное значение.

<dfn>Нетерминальный символ</dfn> (non-terminal symbol) – символ, обозначающий
